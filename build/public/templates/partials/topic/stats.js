...
(function (factory) {
  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    var value = context;
    return (guard((context != null && context['crossposts'] != null) ? context['crossposts']['length'] : null) ?
        "\n<span class=\"badge text-body border border-gray-300 stats text-xs position-relative\">\n<i class=\"fa-regular fa-fw fa-clone visible-xs-inline\" title=\"[[global:crossposts]]\"></i>\n<span component=\"topic/crosspost-count\" title=\"" + 
          __escape(guard((context != null && context['crossposts'] != null) ? context['crossposts']['length'] : null)) + 
          "\" class=\"fw-bold\">" + 
          __escape(helper(context, helpers, 'humanReadableNumber', [guard((context != null && context['crossposts'] != null) ? context['crossposts']['length'] : null)])) + 
